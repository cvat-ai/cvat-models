...
that detects objects from prompts using the [Segment Anything Model 2][sam2] (SAM2)
from Meta Research, as implemented by the [Hugging Face Transformers][transformers] library.
...
All other parameters set with the `-p` option will be passed directly
to the `Sam2Model.from_pretrained` function.
